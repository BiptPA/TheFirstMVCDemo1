                    ...
                    <div class="form-group">
                        <div class="col-xs-12  ">
                            <div class="input-group">
                                ...
                                <input type="text" id="username" name="employerAccount" class="form-control" value="${employer.employerAccount}" placeholder="用户名">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12  ">
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="employerPwd" class="form-control" value="${employer.employerPwd}" placeholder="密码">
                            </div>
                        </div>
                    </div>
