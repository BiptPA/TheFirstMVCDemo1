                    ...
                    <div class="form-group">
                        <div class="col-xs-12  ">
                            <div class="input-group">
                                ...
                                <input type="text" id="username" name="account" class="form-control" value="${employ.account}" placeholder="用户名">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12  ">
                            <div class="input-group">
                                ...
                                <input type="password" id="password" name="pwd" class="form-control" value="${employ.pwd}" placeholder="密码">
                            </div>
                        </div>
                    </div>
